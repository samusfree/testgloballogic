# Mi solución para el Test de [Global Logic](https://www.globallogic.com/latam/) 💪
...
Desarrolle una aplicación que exponga una API RESTful de gestión de usuarios.
...
5. Usar la colección de Postman para probar [Postman collection](readme-files/GlobalLogic.postman_collection.json) dentro de el esta el endpoint para probar y los ejemplos para probar los casos de excepción.
